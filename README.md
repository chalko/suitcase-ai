...
| **VM 9110** | `colt-control-01` | Talos Linux VM | 2 vCPU, 2.5GB RAM, 30GB NVMe | `https://10.82.20.10:6443` | `camp-colt-k8s` Control Plane          | 🟢 Active |
| **VM 9120** | `colt-worker-01`  | Talos Linux VM | 4 vCPU, 6GB RAM, 100GB NVMe  | `10.82.20.13`              | Workload execution & Ingress DaemonSet | 🟢 Active |
